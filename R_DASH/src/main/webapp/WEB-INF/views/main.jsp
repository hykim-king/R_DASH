...
<body>
		...
		<div class="top-bar">
			<div class="d-flex align-items-center">
				...
				<div class="nav-button-group d-none d-md-inline">
					<a href="#news">통계 페이지</a> <a href="#news">지도 페이지</a> <a
						href="#faq">조회 페이지</a>
				</div>
			</div>
			<div>
	...
	<!-- 📰 주요 뉴스 -->
	<div class="news-section animate-on-scroll" id="news">
		<div class="container">
			<div class="news-title">주요 뉴스</div>
			<div class="row">
				<div class="col-md-4 mb-3">
					<div class="card h-100">
						<img src="https://source.unsplash.com/600x400/?earthquake,nature"
							class="card-img-top" alt="지진 이미지">
						<div class="card-body">
				...
				<div class="col-md-4 mb-3">
					<div class="card h-100">
						<img src="https://source.unsplash.com/600x400/?fire,emergency"
							class="card-img-top" alt="화재 이미지">
						<div class="card-body">
				...
				<div class="col-md-4 mb-3">
					<div class="card h-100">
						<img
							src="https://source.unsplash.com/600x400/?ambulance,emergency"
							class="card-img-top" alt="응급 이미지">
						<div class="card-body">
