            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="/ehr/resources/template/dashboard/assets/img/theme/team-4.jpg" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0">
              ...
              <div class="text-center">
                ...
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i>버튼
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" value="${sessionScope.loginUser.name }" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="email" id="input-email" class="form-control" value="${sessionScope.loginUser.email }" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">별명</label>
                        <input type="email" id="input-email" class="form-control" placeholder="ex)부리부리" value="${sessionScope.loginUser.nickname }">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control" placeholder="ex)010-1234-5678" value="${sessionScope.loginUser.tel }" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">우편번호</label>
                        <input id="input-address" class="form-control" placeholder="ex)12345" value="${sessionScope.loginUser.zipCode }" type="text" readonly>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                      <label class="form-control-label" for="input-address">&nbsp;</label>
                        <input type="button" class="form-control" value="주소 찾기">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control" placeholder="ex)사랑시 고백구 행복동" value="${sessionScope.loginUser.address }" type="text" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">상세 주소</label>
                        <input id="input-address" class="form-control" placeholder="ex)에이콘 마을 1004동 1004호" value="${sessionScope.loginUser.detailAddress }" type="text">
                      </div>
                    </div>
                  </div>
                </div>
                <hr class="my-4" />
                <!-- Description -->
                <h4 class="text-muted mb-4">가입일 : 2025-08-09</h4>
              </form>
            </div>
          </div>
        </div>
